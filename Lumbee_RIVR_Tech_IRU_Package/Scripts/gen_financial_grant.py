...
def build_financial_schedule():
    ...
    C.flag_para(doc, C.FLAG_GRANT,
                ...
                "payment structure must not cause the Tribe to mis-apply program income.")
    ...
    comp_rows = [
        ["A — Fixed Annual Payment",
         ...
         "The Tribe values certainty and simplicity over upside."],
        ["B — % of Gross Revenue",
         ...
         "The Tribe wants growth participation and a simple, tamper-resistant base."],
        ["C — % of Adjusted Operating Cash Flow",
         ...
         "The Tribe accepts expense-side complexity in exchange for margin alignment."],
        ["D — Hybrid (Fixed Base + Revenue Share)",
         ...
         "The Tribe wants a guaranteed minimum and meaningful upside — the recommended balance."],
    ...
    C.add_table(doc,
                ["Year", "Fixed annual payment", "Escalator applied", "Payment to Tribe"],
    ...
    C.add_table(doc,
                ...
                [["Gross Revenue (stabilized year)", C.PH("Gross Revenue — 04_Financial_Model")],
                 ...
                 ["= Payment to Tribe (stabilized year)", C.PH("Option B payment")]],
    ...
    C.add_table(doc,
                ...
                [["Gross Revenue (stabilized year)", C.PH("Gross Revenue")],
                 ...
                 ["= Payment to Tribe (stabilized year)", C.PH("Option C payment")]],
                widths=[3.6, 2.9], font_size=9)
    ...
    C.add_table(doc,
                ...
                [["Fixed base payment (floor)", C.PH("fixed base")],
                 ...
                 ["= Total payment to Tribe (base + variable)", C.PH("Option D payment")]],
                widths=[3.6, 2.9], font_size=9)
    ...
    P(doc,
      ...
      f"the holiday ends.")
    C.add_table(doc,
                ["Period", "Payment basis", "Payment to Tribe"],
    ...
    C.flag_para(doc, C.FLAG_BUSINESS,
                ...
                "percentage, and threshold, are business decisions for the Tribe and RIVR Tech, to "
    ...
    C.flag_para(doc, C.FLAG_GRANT,
                ...
                "Tribe’s revenue share before any payment structure is executed.")
    ...
    C.signature_block(
        ...
        extra_note="Confirm signatory authority for financial commitments and whether the Tribal "
                   "party is the Tribe directly or a designated Tribal entity/instrumentality.")
...
def build_grant_addendum():
    ...
    C.section(doc, "2.3", "Title Retained by the Tribe")
    P(doc,
    ...
    C.flag_para(doc, C.FLAG_GRANT,
                ...
                "Tribe’s and may be delegated to RIVR Tech only by written flow-down.")
    ...
    sr_rows = [
        ...
        ["3",
         ...
         "Tribe as recipient; RIVR Tech operates as a competitive commercial provider.",
         "Contractor"],
        ["4",
         "Is responsible for adherence to applicable federal program requirements.",
         "Provides goods or services that are ancillary to the operation of the federal program.",
         "The Tribe, as recipient, is responsible for program compliance; RIVR Tech’s "
        ...
        ["5",
         ...
         "The Tribe carries out the public broadband program; RIVR Tech provides operating "
         "services under the IRU. Note the Tribe does receive the benefit of the operating "
    ...
    C.flag_para(doc, C.FLAG_ATTORNEY,
                "Map any overlapping officials, ownership, or affiliations between the Tribe, "
    ...
    C.flag_para(doc, C.FLAG_GRANT,
                ...
                "performance treatment; this drives how the Tribe may use its revenue share.")
